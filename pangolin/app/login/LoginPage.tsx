...
function Input({ label, type = "text", value, onChange, placeholder, error }) {
  ...
  return (
    <div style={{ marginBottom: "18px" }}>
      ...
      />
      {error && (
        <p style={{ fontSize: "12px", color: C.error, marginTop: "5px" }}>
          {error}
        </p>
      )}
    </div>
        ...
        >
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(ellipse 70% 50% at 50% 60%, rgba(63,208,201,.07) 0%, transparent 70%)",
            }}
          />
          ...
          <div style={{ position: "relative", marginBottom: "36px" }}>
            <div
              style={{
                ...
                inset: "10%",
                background:
                  "radial-gradient(ellipse, rgba(63,208,201,.15) 0%, transparent 70%)",
                borderRadius: "50%",
                filter: "blur(16px)",
            ...
            <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
              <img
                ...
                style={{
                  ...
                  objectFit: "contain",
                  filter:
                    "brightness(0) invert(1) drop-shadow(0 0 10px rgba(63,208,201,.35))",
                  opacity: 1,
                }}
              />
              <div
