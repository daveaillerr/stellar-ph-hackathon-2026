      ...
      <GlassCard glow={C.coral} style={{ padding: "22px 20px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <Btn variant="coral" size="lg" fullWidth onClick={() => go("/delivery")}>
            ✓ Approve & Release ${Number(reviewAmount || 0).toLocaleString()}
          </Btn>
          ...
          {!showDispute ? (
            ...
            <div style={{ background: "rgba(239,68,68,.07)", border: "1px solid rgba(239,68,68,.3)", borderRadius: 12, padding: "14px 16px" }}>
              ...
              <div style={{ fontSize: 12, color: C.textMuted, lineHeight: 1.55, marginBottom: 12 }}>
                A neutral arbitrator will review both sides. The guaranteed floor of ${escrow?.min_guarantee_usdc || 0} USDC is protected for the freelancer.
              </div>
              <div style={{ display: "flex", gap: 8 }}>
