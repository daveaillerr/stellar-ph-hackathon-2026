...
function Btn({
  ...
  const variants = {
    ...
    teal: {
      ...
      color: "#02353C",
      boxShadow: h
        ? `0 12px 40px rgba(63,208,201,.5)`
        : `0 6px 24px rgba(63,208,201,.3)`,
    },
  };
  return (
    <button
...
function GlassCard({ children, glow = C.primary, style = {} }) {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg,rgba(5,64,72,.92),rgba(3,47,54,.96))",
    ...
    >
      ...
      <div
        style={{
          ...
          inset: "10%",
          background:
            "radial-gradient(ellipse at 50% 60%, rgba(63,208,201,.18) 0%, rgba(46,175,125,.1) 40%, transparent 70%)",
          borderRadius: "50%",
          filter: "blur(20px)",
      ...
      >
        ...
        >
          ...
          <div className="desktop-nav">
            <Btn variant="primary" size="md" onClick={() => go("/login")}>
              Get Started
            </Btn>
          </div>
      ...
      >
        {links.map((l) => (
          <a
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.background = "rgba(63,208,201,.08)")
            }
            onMouseLeave={(e) =>
    ...
    >
      ...
      <div
        style={{
          ...
          opacity: 0.03,
          backgroundImage:
            "linear-gradient(rgba(193,246,237,1) 1px,transparent 1px),linear-gradient(90deg,rgba(193,246,237,1) 1px,transparent 1px)",
          ...
          <div style={{ flex: "1 1 440px", maxWidth: "560px" }}>
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(135deg,#2EAF7D 20%,#3FD0C9 60%,#C1F6ED 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                }}
              >
            ...
            >
              Pangolin is a Web3 escrow platform built for Filipino freelancers
              and their clients. Every peso protected, every milestone tracked,
              every dispute resolved — on-chain, in seconds.
            </p>
            ...
            >
              <Btn variant="primary" size="lg" onClick={() => go("/login")}>
                ...
                {["AK", "JM", "MR", "PB", "LO"].map((init, i) => (
                  <div
                    ...
                    style={{
                      ...
                      fontSize: "11px",
                      fontWeight: 700,
                      color: [C.primary, C.teal, C.green, C.mint, "#449342"][i],
      ...
      <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
        <div
          style={{
            ...
            borderRadius: "20px",
            boxShadow:
              "0 8px 40px rgba(46,175,125,.1), 0 2px 12px rgba(0,0,0,.06)",
          ...
          {items.map(({ icon, title }, i) => (
            <div
              ...
              style={{
                ...
                padding: "28px 32px",
                borderRight:
                  i < items.length - 1 ? "1px solid #E0F7F3" : "none",
              }}
            >
              <div
                style={{
                  ...
                  flexShrink: 0,
                  background:
                    "linear-gradient(135deg,rgba(63,208,201,.15),rgba(46,175,125,.1))",
...
function HowItWorks() {
  const steps = [
    {
      ...
      num: "01",
      title: "Create a Job",
      desc: "Describe your project, set milestones, invite your counterpart. Smart contract is generated automatically.",
    },
    {
      icon: "💰",
      num: "02",
      title: "Fund Escrow",
      desc: "Client deposits payment in XLM or USDC. Funds are locked on Stellar — visible to both parties, touchable by neither.",
    },
    {
      icon: "🚀",
      num: "03",
      title: "Deliver Work",
      desc: "Freelancer completes milestones. Files, proofs, and deliverables uploaded directly to the contract thread.",
    },
  ];
  ...
  return (
    <section
      id="how-it-works"
      style={{ padding: "100px 24px", background: "#F0FDFB" }}
    >
      <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "64px" }}>
          ...
          >
            From contract to cash — the whole flow lives on-chain so nobody can
            ghost, dispute unfairly, or delay payment.
          </p>
        </div>
        ...
        >
          ...
          {steps.map(({ icon, num, title, desc }, i) => (
            ...
            >
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: "20px",
                    background:
                      "linear-gradient(135deg,rgba(46,175,125,.12),rgba(63,208,201,.08))",
              ...
              <p
                style={{ fontSize: "14px", color: "#2A7A70", lineHeight: 1.7 }}
              >
                {desc}
              </p>
            </div>
...
function Features() {
  const features = [
    {
      icon: "🔒",
      title: "Minimum Guaranteed Payment",
      desc: "Set a non-negotiable floor. Clients can't walk away with your work without paying at least the agreed minimum.",
      color: C.primary,
    },
    {
      icon: "💎",
      title: "Ultra-Low Fees",
      desc: "Flat 2.5% per transaction. No monthly subscription, no hidden charges, no percentage creep. Ever.",
      color: C.green,
    },
    {
      icon: "⛓️",
      title: "Blockchain Proof",
      desc: "Every transaction, milestone, and release is recorded immutably on Stellar. Your receipt is the blockchain.",
      color: C.teal,
    },
  ];
  ...
  return (
    <section
      style={{
        padding: "100px 24px",
        background: `linear-gradient(180deg,${C.surface} 0%,${C.base} 100%)`,
      }}
    >
      <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "64px" }}>
          ...
          >
            Every feature exists to protect your money, your time, and your
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: h
          ? `0 16px 48px rgba(0,0,0,.5), 0 0 32px ${color}15`
    ...
    >
      ...
      <p style={{ fontSize: "14px", color: C.textSub, lineHeight: 1.7 }}>
        {desc}
      </p>
    </div>
  );
...
function ComparisonTable() {
  const rows = [
    ...
    },
    {
      ...
      pangolin: "3–5 seconds",
      platformX: "1–3 business days",
    },
    {
      feature: "Escrow Protection",
      pangolin: "✅ Native, on-chain",
      platformX: "❌ Off-platform, manual",
    },
    {
      feature: "Non-Marketplace Use",
      pangolin: "✅ Any freelancer",
      platformX: "❌ Platform-specific",
    },
    {
      feature: "Dispute Resolution",
      pangolin: "✅ Smart contract",
      platformX: "❌ Manual, centralized",
    },
    {
      feature: "Blockchain Receipts",
      pangolin: "✅ Stellar network",
      platformX: "❌ No",
    },
  ];

  const cols = ["Feature", "Pangolin", "Platform X"];
    ...
    <section style={{ padding: "100px 24px", background: C.base }}>
      <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "64px" }}>
          ...
          >
            No other platform gives Filipino freelancers this combination of
        ...
        >
          <div style={{ overflowX: "auto" }}>
            ...
            >
                  ...
                  {cols.map((c, i) => (
                    <th
                      ...
                      style={{
                        ...
                        background:
                          i === 1 ? "rgba(63,208,201,.06)" : "transparent",
                        borderRight:
                          i < cols.length - 1
                            ? `1px solid ${C.border}`
                            : "none",
              ...
              <tbody>
                {rows.map(({ feature, pangolin, platformX }, ri) => (
                  <tr
                    key={feature}
                    style={{
                      borderBottom:
                        ri < rows.length - 1
                          ? `1px solid rgba(10,85,96,.5)`
                          : "none",
                      transition: "background .15s",
                    }}
                    onMouseEnter={(e) =>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "640px", margin: "0 auto" }}>
        ...
        >
          <img
            ...
            style={{
              ...
              height: "120px",
              objectFit: "contain",
              filter: "drop-shadow(0 4px 20px rgba(63,208,201,.3))",
            }}
          />
        </div>
        <h2
        ...
        >
          Join 1,240+ Filipino freelancers who trust Pangolin to secure their
          income, protect their work, and get paid on time — every time.
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          <Btn variant="primary" size="xl" onClick={() => go("/login")}>
            Get Started Free
          </Btn>
          <Btn variant="secondary" size="xl" onClick={() => go("/login")}>
            Freelancer Login
          </Btn>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ flex: "1 1 240px", maxWidth: "280px" }}>
            ...
            >
              Secure escrow for the Philippine creative economy, powered by
              Stellar blockchain.
            </p>
            <div
              style={{
            ...
            >
              ...
              />
              <span
                style={{ fontSize: "12px", fontWeight: 700, color: C.teal }}
              >
                Built on Stellar
              </span>
            </div>
        ...
        >
          <span style={{ fontSize: "13px", color: C.textMuted }}>
            © 2025 Pangolin Protocol. All rights reserved.
          </span>
